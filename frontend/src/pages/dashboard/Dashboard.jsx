     ...
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Товары</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Сумма Продаж</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Трендовые Книги Этого Месяца</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Количество Заказов</span>
                </div>
              </div>
            </section>
